              ...
              <div className="relative" id="user-menu">
                ...
                {dropOpen && (
                  <div className="absolute right-0 top-full mt-2 w-52 bg-white rounded-2xl shadow-xl border border-gray-100 py-2 z-50">
                    ...
                    <Link href="/settings" onClick={() => setDropOpen(false)} className="flex items-center gap-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors">⚙️ Settings</Link>
            ...
            <div className="border-t border-gray-100 mt-2 pt-3 flex flex-col gap-1">
              {isLoggedIn ? (
                <>
                  ...
                  <Link href="/settings" onClick={() => setMenuOpen(false)} className="px-3 py-2.5 rounded-lg text-sm text-gray-700 hover:bg-green-50 hover:text-green-700 transition-colors font-medium">⚙️ Settings</Link>
                ...
                <div className="flex gap-3">
                  <Link href="/login" onClick={() => setMenuOpen(false)} className="flex-1 text-center py-2.5 rounded-xl border border-green-600 text-green-700 font-semibold text-sm hover:bg-green-50 transition-colors">
                    Sign In
                  </Link>
                  <Link href="/register" onClick={() => setMenuOpen(false)} className="flex-1 text-center py-2.5 rounded-xl green-gradient text-white font-semibold text-sm">
                    Join Free
                  </Link>
                </div>
              )}
