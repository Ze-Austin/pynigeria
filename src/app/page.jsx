    ...
    <>
      ...
      <style jsx global>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .nav-mobile-menu {
          ...
          border-bottom: 1px solid rgba(73,72,71,0.3);
          padding: 1rem 1.5rem;
        ...
        @media (max-width: 900px) {
          ...
          .feed-image-panel { display: none !important; }
          ...
          .leaderboard-text { text-align: left !important; }
        ...
        @media (max-width: 600px) {
          ...
          /* Leaderboard entries: wrap XP below name */
          .lb-row {
            flex-wrap: wrap;
            gap: 0.5rem;
          }
      ...
      <nav style={{
        ...
        <div className={`nav-mobile-menu${menuOpen ? " open" : ""}`}>
          {["RESOURCES", "JOB", "CHALLENGES", "PROFILE","COMMUNITY"].map((item, i) => (
            <a key={item} href="#" className={i === 0 ? "nav-link-active" : "nav-link"} onClick={() => setMenuOpen(false)}>
              {item}
            </a>
          ))}
      ...
      <main style={{ paddingTop: "5rem" }}>
        ...
        <section style={{ minHeight: 900, display: "flex", alignItems: "center", padding: "5rem 1.5rem", maxWidth: 1440, margin: "0 auto" }}>
          <div className="hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3rem", alignItems: "center", width: "100%" }}>
